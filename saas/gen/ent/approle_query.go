...
// QueryAppPerms chains the current query on the "app_perms" edge.
func (arq *AppRoleQuery) QueryAppPerms() *AppPermQuery {
	query := (&AppPermClient{config: arq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := arq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (arq *AppRoleQuery) QueryAppRolePerms() *AppRolePermQuery {
	query := (&AppRolePermClient{config: arq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := arq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (arq *AppRoleQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (arq *AppRoleQuery) FirstIDX(ctx context.Context) string {
...
func (arq *AppRoleQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (arq *AppRoleQuery) OnlyIDX(ctx context.Context) string {
...
func (arq *AppRoleQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (arq *AppRoleQuery) IDsX(ctx context.Context) []string {
	ids, err := arq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (arq *AppRoleQuery) Clone() *AppRoleQuery {
	...
	return &AppRoleQuery{
		...
		withAppPerms:     arq.withAppPerms.Clone(),
		withAppRolePerms: arq.withAppRolePerms.Clone(),
...
// WithAppPerms tells the query-builder to eager-load the nodes that are connected to
// the "app_perms" edge. The optional arguments are used to configure the query builder of the edge.
func (arq *AppRoleQuery) WithAppPerms(opts ...func(*AppPermQuery)) *AppRoleQuery {
	query := (&AppPermClient{config: arq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	arq.withAppPerms = query
	return arq
}
...
func (arq *AppRoleQuery) WithAppRolePerms(opts ...func(*AppRolePermQuery)) *AppRoleQuery {
	query := (&AppRolePermClient{config: arq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	arq.withAppRolePerms = query
	return arq
}
...
func (arq *AppRoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AppRole, error) {
	var (
		...
		loadedTypes = [3]bool{
			arq.withApp != nil,
			arq.withAppPerms != nil,
			arq.withAppRolePerms != nil,
		}
	)
	...
	if query := arq.withAppPerms; query != nil {
		if err := arq.loadAppPerms(ctx, query, nodes,
			func(n *AppRole) { n.Edges.AppPerms = []*AppPerm{} },
			func(n *AppRole, e *AppPerm) { n.Edges.AppPerms = append(n.Edges.AppPerms, e) }); err != nil {
			return nil, err
		}
	}
	if query := arq.withAppRolePerms; query != nil {
		if err := arq.loadAppRolePerms(ctx, query, nodes,
			func(n *AppRole) { n.Edges.AppRolePerms = []*AppRolePerm{} },
			func(n *AppRole, e *AppRolePerm) { n.Edges.AppRolePerms = append(n.Edges.AppRolePerms, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range arq.withNamedAppPerms {
		if err := arq.loadAppPerms(ctx, query, nodes,
			func(n *AppRole) { n.appendNamedAppPerms(name) },
			func(n *AppRole, e *AppPerm) { n.appendNamedAppPerms(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range arq.withNamedAppRolePerms {
		if err := arq.loadAppRolePerms(ctx, query, nodes,
			func(n *AppRole) { n.appendNamedAppRolePerms(name) },
			func(n *AppRole, e *AppRolePerm) { n.appendNamedAppRolePerms(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (arq *AppRoleQuery) loadApp(ctx context.Context, query *AppQuery, nodes []*AppRole, init func(*AppRole), assign func(*AppRole, *App)) error {
	...
	nodeids := make(map[string][]*AppRole)
	for i := range nodes {
		fk := nodes[i].AppID
...
func (arq *AppRoleQuery) loadAppPerms(ctx context.Context, query *AppPermQuery, nodes []*AppRole, init func(*AppRole), assign func(*AppRole, *AppPerm)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[string]*AppRole)
	nids := make(map[string]map[*AppRole]struct{})
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(approle.AppPermsTable)
		s.Join(joinT).On(s.C(appperm.FieldID), joinT.C(approle.AppPermsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(approle.AppPermsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(approle.AppPermsPrimaryKey[0]))
	...
	neighbors, err := withInterceptors[[]*AppPerm](ctx, query, qr, query.inters)
	if err != nil {
		return err
	}
	for _, n := range neighbors {
		nodes, ok := nids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected "app_perms" node returned %v`, n.ID)
		}
		for kn := range nodes {
			assign(kn, n)
		}
...
func (arq *AppRoleQuery) loadAppRolePerms(ctx context.Context, query *AppRolePermQuery, nodes []*AppRole, init func(*AppRole), assign func(*AppRole, *AppRolePerm)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(approleperm.FieldAppRoleID)
	}
	query.Where(predicate.AppRolePerm(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(approle.AppRolePermsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (arq *AppRoleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(approle.Table, approle.Columns, sqlgraph.NewFieldSpec(approle.FieldID, field.TypeString))
	_spec.From = arq.sql
...
// WithNamedAppPerms tells the query-builder to eager-load the nodes that are connected to the "app_perms"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (arq *AppRoleQuery) WithNamedAppPerms(name string, opts ...func(*AppPermQuery)) *AppRoleQuery {
	query := (&AppPermClient{config: arq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if arq.withNamedAppPerms == nil {
		arq.withNamedAppPerms = make(map[string]*AppPermQuery)
	}
	arq.withNamedAppPerms[name] = query
	return arq
}

// WithNamedAppRolePerms tells the query-builder to eager-load the nodes that are connected to the "app_role_perms"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (arq *AppRoleQuery) WithNamedAppRolePerms(name string, opts ...func(*AppRolePermQuery)) *AppRoleQuery {
	query := (&AppRolePermClient{config: arq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if arq.withNamedAppRolePerms == nil {
		arq.withNamedAppRolePerms = make(map[string]*AppRolePermQuery)
	}
	arq.withNamedAppRolePerms[name] = query
	return arq
}
